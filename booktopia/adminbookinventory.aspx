<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="booktopia.adminbookinventory" %>
               ...
               <div class="card-body">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:Button class="form-control btn btn-outline-primary" ID="Button4" runat="server" Text="Go" OnClick="Button4_Click" />
                           </div>
                        </div>
                     </div>
                     <div class="col-md-8">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Total books" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                  ...
                  <div class="row">
                     ...
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-outline-secondary" runat="server" Text="Update" OnClick="Button3_Click" />
                     </div>
                     <div class="col-4">
                                          ...
                                          <div class="col-lg-10">
                                             ...
                                             <div class="row">
                                                <div class="col-12">
                                                   ...
                                                   &nbsp;| <span><span>&nbsp;</span>gener - </span>
                                                   <asp:Label ID="Label3" runat="server" Font-Bold="True" Text='<%# Eval("gener") %>'></asp:Label>
                                                   &nbsp;| 
                                                   <span>
                                                      Language -<span>&nbsp;</span>
                                             ...
                                             <div class="row">
                                                <div class="col-12">
                                                   ...
                                                   &nbsp;| Rating -
                                                   <asp:Label ID="Label10" runat="server" Font-Bold="True" Text='<%# Eval("rating_sum") %>'></asp:Label>
                                                   &nbsp;| Available Stock -
